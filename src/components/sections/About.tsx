      ...
      <div className="container">
        ...
        <div className="about-grid">
          <div className="about-text">
            <p>
              I’ve never liked sticking to just one niche. My
              curiosity takes me everywhere—from game engines and
              AI to embedded systems and mobile-web. For me,
              software isn’t about picking a &apos;side&apos;;
              it’s about having the drive to explore how it all
              works under the hood.
            </p>
            <p>
              I’m a builder, not a reader. If there’s something I
              don’t know, I’ll sit down and grind for a week or a
              month until I can actually build something with it.
              I don&apos;t believe I&apos;ve truly learned a
              technology until I’ve made it work in a real-world
              project.
            </p>
          </div>
